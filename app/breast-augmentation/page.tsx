...
/**
 * Identical to /breast-lift and /mommy-makeover apart from the content object
 * it is handed.
 *
 * That is the whole point of the arrangement: a landing page is a content file
 * and a route, sharing every component, so a design fix lands on all three
 * pages at once and cannot be applied to one and forgotten on the others.
 */
